...
// a separate template  (see render.typ for the V1 SIMPLIFICATIONS block
...
// needed, so this template compiles even after a separate template  and
...
// reference reads, implemented independently here (no shared code, per
